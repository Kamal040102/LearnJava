...
public class CWH_PS4_Q2 {
    public static void main(String[] args) {
         ...
         * which will generate the result according to the marks entered by the user:
         * 
         * Result-1: If the user is passed in all the subjects then only user will be
         * considered "Pass" in the exam. For this, user has to score more than or equal
         * to 33% in each subject "and" 40% of the total marks.
         * 
         * Result-2: If the user is failed in any of the subject i.e. if the marks are
         * less than 33% in any of the subject then user will be considered "Fail" in
         * exam.
         * 
         * Result-3: If the user is pass in all exam but the total marks scored by the
         * user is less than 40% of the total marks then user will be considered "Fail"
         * in the exam.
         * -----------------------------------------------------------------------------
         * -------------------------------------------------------
         */
        ...
        try {
            ...
            if (marksOfSubject1 < passingMarksOfEachSubject || marksOfSubject2 < passingMarksOfEachSubject
                    || marksOfSubject3 < passingMarksOfEachSubject) {
                System.out.println(" ");
